...
DasCard = 2; % is there a dascard available? 0 = no, 1 = oldskool Das (e.g. DM2), 2 = Modern Das (e.g. Ulf's setup)
...
Set.LogLoc = fullfile('C:','Users',usname,'Dropbox','MouseOutput','RFMap');
